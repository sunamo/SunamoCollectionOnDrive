...
internal class Exceptions
{
    ...
    internal static string? IsNull<T>(string before, string variableName, T? variable)
    {
        var isNull = variable is null;
        return isNull ? CheckBefore(before) + variableName + " " + "is null" + "." : null;
    }
